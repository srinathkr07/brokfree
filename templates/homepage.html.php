...
<head>
  ...
  width:100vw;
  height:100vh;
  background-image: url(http://www.gingercreek.org/wp-content/uploads/2018/07/142443-widescreen-blue-ombre-background-1920x1080-photo.jpg);
...
.post-ads-title {
    ...
    box-shadow: 0 4px 10px 4px rgba(8, 25, 37, 0.3);
    padding:10px;
    text-align: center;
...
.pics-slider {
    background-color: rgb(187, 248, 168);
    box-shadow: 0 4px 10px 4px rgba(8, 25, 37, 0.3);
    border-radius: 10px;
    margin:50px 50px 0 50px;
}
.pics-slider .pics-title {
    text-align: center;
    padding:3px;
}
.pics-slider .pics-info {
    text-align: center;
    padding:3px;
}
#slider{
...
<body onload="document.body.classList.add('loaded')">
    ...
    <div class="container">
        ...
        <div class="pics-slider">
            ...
            <div id='slider'>
                <ul class='slides'>
                    <li class='slide'><img src='https://cdn.freshome.com/wp-content/uploads/2016/11/freshome-nordic-scandinavian62.png'
                            style='width:720px; height:400px;'></li>
                    <li class='slide'><img src='https://cdn.freshome.com/wp-content/uploads/2014/07/blue-yellow-grey-living-room.jpg'
                            style='width:720px; height:400px;'></li>
