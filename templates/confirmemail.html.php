                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c" align="left">
                                                                                        <h1 style="color: #ffffff; line-height: 100%; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;">Brokfree</h1>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p10b" align="left">
                                                                                        <p style="font-size: 16px; color: #777777; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;">Welcome to Brokfree and thanks for signing up! You're one step away from&nbsp;finding the finest homes in Chennai.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                    ...
                                                                    <td class="esd-container-frame" width="530" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p30t es-p15b" align="center"> 
                                                                                        <span class="es-button-border" style="background: rgb(237, 142, 32) none repeat scroll 0% 0%;"> 
                                                                                        <a href="<?=$url?>" class="es-button" target="_blank" style="font-weight: normal; border-width: 15px 30px; background: rgb(237, 142, 32) none repeat scroll 0% 0%; border-color: rgb(237, 142, 32); color: rgb(255, 255, 255); font-size: 18px;">Confirm account</a> 
                                                                                    </span>
                                                                                 </td>
                                                                                </tr>
                                                                            </tbody>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr class="links-images-top">
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l " style="padding-bottom: 30px; padding-top: 35px; " width="25.00%" bgcolor="transparent" align="center">
                                                                                                        <a target="_blank" style="color: #ffffff; font-size: 20px;" href=""> <img src="https://tlr.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/60961522067175378.png" alt="" title="" class="es-p5b" height="27" align="absmiddle"><br> </a>
                                                                                                    </td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l " style="padding-bottom: 30px; padding-top: 35px; " width="25.00%" bgcolor="transparent" align="center">
                                                                                                        <a target="_blank" style="color: #ffffff; font-size: 20px;" href=""> <img src="https://tlr.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/72681522067183042.png" alt="" title="" class="es-p5b" height="27" align="absmiddle"><br> </a>
                                                                                                    </td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l " style="padding-bottom: 30px; padding-top: 35px; " width="25.00%" bgcolor="transparent" align="center">
                                                                                                        <a target="_blank" style="color: #ffffff; font-size: 20px;" href=""> <img src="https://tlr.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/76121522068412489.jpg" alt="" title="" class="es-p5b" height="27" align="absmiddle"><br> </a>
                                                                                                    </td>
                                                                                                    <td class="es-p10t es-p10b es-p5r es-p5l " style="padding-bottom: 30px; padding-top: 35px; " width="25.00%" bgcolor="transparent" align="center">
                                                                                                        <a target="_blank" style="color: #ffffff; font-size: 20px;" href=""> <img src="https://tlr.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/12411522072775563.jpg" alt="" title="" class="es-p5b" height="27" align="absmiddle"><br> </a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p15b" align="center">
                                                                                        <a target="_blank"> <img src="https://tlr.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/12331522050090454.png" alt="Beretun logo" style="display: block;" title="Brokfree" width="37"> </a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p35b" align="center">
                                                                                        <p><b>Mailing residential address of the company</b></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
